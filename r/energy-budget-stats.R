...
save(proportions,file="output/proportions_nofeature.RData")
save(all_data,file="output/all_data_nofeature.RData")
save(summary_output,file="output/summary_output_nofeature.RData")

load(file="output/summary_output_nofeature.RData")
